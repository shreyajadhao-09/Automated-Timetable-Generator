...
private String lastseen; 
	...
	public List<ViewStaff> getStaff(){
		...
		try {
			...
			rs=st.executeQuery("select * from staffpersonal where usertype='staff';");
...
public List<ViewStaff> getStaff1(String branch){
		...
		try {
			...
			rs=st.executeQuery("select * from staffpersonal where usertype='staff'");
			System.out.println("select * from staffpersonal where usertype='staff' ");
			while(rs.next()) {
...
public List<ViewStaff> getBA(){
		...
		try {
			...
			rs=st.executeQuery("select * from staffpersonal where usertype='branchadmin';");
