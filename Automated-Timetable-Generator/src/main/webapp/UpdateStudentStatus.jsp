...
<body>
    ...
    <div class="container mt-4">
        <h2 class="text-center">Student Pending Registration Report</h2>
        <hr>
        ...
        <table class="table table-bordered text-center">
            ...
            <tbody>
             ...
             onclick="showPhoto('Uploads/${rec.path}')">
                        ...
                        <td>
                            <a href="activatestudent?userid=${rec.userid}&usernm=${rec.usernm}&email=${rec.emailid}" class="btn btn-success btn-sm">Activate</a>
                        </td>
                    </tr>
                </soham:forEach>
