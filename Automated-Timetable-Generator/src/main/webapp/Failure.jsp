...
else if(request.getAttribute("activity").toString().trim().equals("NotProperDistribution"))
{
	%>
	Please Distribute Marks Properly!!
	<%
}
else if(request.getAttribute("activity").toString().trim().equals("insufficientQues"))
{
	%>
	Insufficient Questions!! Please insert questions and then try again!!
	<%
}
