...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="index.html" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary"><i class="fa fa-book me-3"></i>Smartsched</h2>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <% if(session.getAttribute("usertype").toString().trim().equals("admin")) { %>
                    ...
                    <a class="nav-item nav-link" href="PrefSubmissionDt.jsp">Set Preference Submission Date</a>
                ...
                <% } else if(session.getAttribute("usertype").toString().trim().equals("branchadmin")) { %>
                    ...
                    <a class="nav-item nav-link" href="viewstudent">View Student</a>
                    <a class="nav-item nav-link" href="RegSubject">Subject Registration</a>
                    <a class="nav-item nav-link" href="SubAllocation">Subject Allocation</a>
                    <a class="nav-item nav-link" href="approvestudentlist">Pending students</a>
                <% } else if(session.getAttribute("usertype").toString().trim().equals("staff")) { %>
                    <a class="nav-item nav-link" href="viewMyAllottedSubjects">View My Allotted Subjects</a>
                    <a class="nav-item nav-link" href="editProfile1">My Profile</a>
                    <a class="nav-item nav-link" href="viewstudent">View Students</a>
                <% } else if(session.getAttribute("usertype").toString().trim().equals("student")) { %>
                    ...
                    <a class="nav-item nav-link" href="viewStudSubjects1">Set Preferences</a>
                    <a class="nav-item nav-link" href="viewStudSubjects">View Subjects</a>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Automatic Time Table Generator System</h1>
                    <nav aria-label="breadcrumb justify-content-center">
                        ...
                        <% } %>
                        <h6 class="breadcrumb-item">Logged in as <%=session.getAttribute("userid").toString()%> (<%=session.getAttribute("usertype").toString()%>)</h6>
                    </nav>
                </div>
            </div>
        </div>
