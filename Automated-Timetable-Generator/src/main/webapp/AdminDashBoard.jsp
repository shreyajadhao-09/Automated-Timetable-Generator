...
function makeGetRequest2(st) {
    ...
    http.open('get', 'ShowSubjects_PendingEle1?semester=' + semester+"&courseId="+courseId+"&branch="+branch);
...
<h2>Elective Subjects Allocation Dashboard</h2>
<table class="tblform">
	<!-- <tr>
		<td>Branch ID</td>
	...
	<option value=""><--select Semester--></option>
	 ...
	 <td>
		<input type="button" onclick="makeGetReqEle()" value="Show Dash Board">
		</td>
	 </tr> 
</table>
</div> 
